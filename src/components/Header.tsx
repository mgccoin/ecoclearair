...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:px-8">
          ...
          <button
            ...
            className="relative flex h-10 w-10 items-center justify-center rounded-lg text-gray-700 transition-colors hover:bg-gray-100 lg:hidden"
      ...
      {/* Mobile Overlay — rendered outside header to avoid backdrop-filter containing block issues */}
      {mobileOpen && (
        <div
      ...
      {/* Mobile Slide-in Menu — rendered outside header */}
      <div
        className={`fixed right-0 top-0 z-[100] flex h-full w-80 max-w-[85vw] flex-col bg-white shadow-2xl transition-transform duration-300 lg:hidden ${
